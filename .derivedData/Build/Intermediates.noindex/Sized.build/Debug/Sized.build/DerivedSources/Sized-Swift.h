...
#ifndef SIZED_SWIFT_H
#define SIZED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Sized",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Sized11ActivePanel")
@interface ActivePanel : NSPanel
@property (nonatomic, readonly) BOOL hasKeyAppearance;
@property (nonatomic, readonly) BOOL hasActiveAppearance;
